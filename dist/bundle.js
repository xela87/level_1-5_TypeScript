...
var btnDown = document.getElementById('button-timer-down');
var btnUp = document.getElementById('button-timer-up');
var btnStart = document.getElementById('timer-start');
var description = document.getElementById('timer-description');
var timer = document.getElementById('clock-face');
...
function startTimer(currentTime) {
    ...
    setTimeout(function () {
        return startTimer(currentTime - 1);
    }, 1000);
}
